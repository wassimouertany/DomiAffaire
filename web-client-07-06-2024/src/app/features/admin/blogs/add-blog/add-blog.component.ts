...
export class AddBlogComponent implements OnInit {
  ...
  loadBlogData(id: any): void {
    // Fetch blog data from service and populate form fields
    // Example:
    this.adminService.getBlog(id).subscribe((blog: any) => {
  ...
  onSubmit() {
    if (this.isEdit && this.blogId) {
      ...
      this.adminService.updateBlog(this.blogId, formData).subscribe({
        next: (data: any) => {
